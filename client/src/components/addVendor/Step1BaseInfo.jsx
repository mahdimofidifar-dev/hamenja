  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <Field>
        ...
        />
        <FieldDescription>نام اصلی که در کارت و بالاترین بخش نمایش داده می‌شود.</FieldDescription>
      </Field>
      ...
      <Field>
        ...
        <CategorySelector
          ...
          onChange={(newCategories) => setFormData({ ...formData, categories: newCategories })}
        />
      </Field>
